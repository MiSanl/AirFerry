...
| 文件 | 说明 |
|------|------|
| `airferry-receiver-android-arm64-v1.1.4.apk` | Android 接收端（Android 10+，arm64-v8a） |
| `airferry-receiver-windows-x64-v1.1.4.zip` | Windows 接收端（Windows 10+，x64；需 .NET 8 Desktop Runtime；由 CI `windows.yml` 打包） |
